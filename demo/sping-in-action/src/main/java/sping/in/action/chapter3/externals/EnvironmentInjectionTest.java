...
public class EnvironmentInjectionTest {
    ...
    @RunWith(SpringJUnit4ClassRunner.class)
    @ContextConfiguration("classpath:/META-INF/spring/chapter-3-placeholder-config.xml")
    ...
    @RunWith(SpringJUnit4ClassRunner.class)
    @ContextConfiguration(classes = EnvironmentConfigWithPlaceHolder.class)
    public static class InjectFromProperties_AutoConfig {

        @Autowired
        private BlankDiscWithPlaceHolder blankDisc;
